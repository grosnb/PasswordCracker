...
public class StaticSHA256 {

    public static Triplet<String, String, String> randomHashN(int n) {
    ...
    public static Triplet<String, String, String> randomHash() {
        String password = getUniqueString();
        Pair<String, String> pair = hashRandomSalt(password);
        return new Triplet<String, String, String>(password, pair.getLeft(), pair.getRight());
    }

    public static Pair<String, String> hashRandomSalt(String password) {
